    ...
    <Appbar.Header style={{ backgroundColor: "#4B5D67", position: "relative", width: "100%", height: "100%" }}>
      <View style={{ width: "100%", height: "100%", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
        <TouchableOpacity style={TouchableOpacityCss("15%")}
          ...
          {index === 1 && <View style={{ width: "100%", height: 4, backgroundColor: "yellow" , position:"absolute" , bottom:0 }}></View>}
          <Icons name="home" color="white" size={25} />
        </TouchableOpacity>

        <TouchableOpacity activeOpacity={0.2} style={TouchableOpacityCss("15%")} onPress={() => { onChnageTab(2) }}>
        {index === 2 && <View style={{ width: "100%", height: 4, backgroundColor: "yellow" , position:"absolute" , bottom:0 }}></View>}
          <Text style={{ color: "white" }}>
            Sell
          </Text>
        </TouchableOpacity>
        <TouchableOpacity style={TouchableOpacityCss("20%")} onPress={() => { onChnageTab(3) }}>
        {index === 3 && <View style={{ width: "100%", height: 4, backgroundColor: "yellow" , position:"absolute" , bottom:0 }}></View>}
          <Text style={{ color: "white" }}>
            serveces
          </Text>
        </TouchableOpacity>
        <TouchableOpacity style={TouchableOpacityCss("15%")} onPress={() => { onChnageTab(4) }}>
        {index === 4 && <View style={{ width: "100%", height: 4, backgroundColor: "yellow" , position:"absolute" , bottom:0 }}></View>}
          <Image style={{ height: "100%", width: "70%" }} source={require("../../assets/help.png")} />
        </TouchableOpacity>
        <TouchableOpacity style={TouchableOpacityCss("15%")}>
        {index === 5 && <View style={{ width: "100%", height: 4, backgroundColor: "yellow" , position:"absolute" , bottom:0 }}></View>}
        ...
        {index === 6 && <View style={{ width: "100%", height: 4, backgroundColor: "yellow" , position:"absolute" , bottom:0 }}></View>}
